...
def exchangeable_value(budget, exchange_rate, spread, denomination):
    ...
    value = estimate_value(budget, exchange_rate * (1 + spread / 100))
    number = get_number_of_bills(value, denomination)

    return get_value(denomination, number)
